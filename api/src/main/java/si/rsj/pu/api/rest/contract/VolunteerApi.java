...
public interface VolunteerApi {
    ...
    VolunteerResponse getVolunteer(@PathParam("id") String id);
    ...
    Response createVolunteer(@Valid CreateVolunteerRequest request);
    ...
    VolunteerResponse updateVolunteer(@PathParam("id") String id, @Valid UpdateVolunteerRequest request);
    ...
    Response deleteVolunteer(@PathParam("id") String id);
