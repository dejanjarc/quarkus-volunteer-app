...
public interface HourLogApi {
    ...
    HourLogResponse getHourLog(@PathParam("id") String id);
    ...
    Response createHourLog(@Valid CreateHourLogRequest request);
    ...
    HourLogResponse updateHourLog(@PathParam("id") String id, @Valid UpdateHourLogRequest request);
    ...
    Response deleteHourLog(@PathParam("id") String id);
